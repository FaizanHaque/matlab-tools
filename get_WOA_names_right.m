...
%     │        'oa'   for Statistical mean minus objectively analyzed mean
%     │        'gp'   for Grid points
...
%              '5d'   for 5°x5°
%
% Note that not all field types are available for the different grid resolutions.
% To learn more about the available field types and additional aspects of the 
% World Ocean Atlas, read product documentation: https://data.nodc.noaa.gov/woa/WOA13/DOC/woa13documentation.pdf
%
%   output:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%case 'mn'
%  my.field_type = 'StatMean' ; % Statistical mean
%case 'dd'
%  my.field_type = 'NumObs' ; % Number of observations
%case 'se'
%  my.field_type = 'StErrorOfMean' ; % Standard error of the mean
%case 'ma'
%  my.field_type = 'SeasonMinusAnMean' ; % Season/month minus annual mean
%case 'gp'
%  my.field_type = 'GridPoints' ; % Grid Points
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%case '04'
%  my.res = 'WOA0.25x0.25' ; nc_file.res = '0.25' ; 
%case '5d'
%  my.res = 'WOA5x5' ; nc_file.res = '5.00' ; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 otherwise
